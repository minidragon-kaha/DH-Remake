...
public class CanvasHelper : MonoBehaviour
{
    ...
    private static Vector2 wantedReferenceResolution = new Vector2(1080, 1920);//(2048f, 2048f);
    ...
    public static RectTransform lastSafeAreaTransform;

    [SerializeField] private bool m_setDDOL = true;
    ...
    void Awake()
    {
        ...
        safeAreaTransform = transform.Find("SafetyArea") as RectTransform;
        lastSafeAreaTransform = safeAreaTransform;
        ...
        if (m_setDDOL) DontDestroyOnLoad(this);
    }
